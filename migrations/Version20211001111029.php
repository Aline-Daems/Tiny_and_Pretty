 ...
 */
final class Version20211001111029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE size_choice_size (size_id INT NOT NULL, choice_size_id INT NOT NULL, INDEX IDX_82EAF179498DA827 (size_id), INDEX IDX_82EAF179706B6C69 (choice_size_id), PRIMARY KEY(size_id, choice_size_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
